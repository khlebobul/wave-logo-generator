var svgString = '<svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">' +
...
renderCallback: function() {
    ...
    document.getElementById('jpeg-container').innerHTML = '<img src="'+img+'"/>';
